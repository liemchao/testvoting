...
const TABLE_HEAD = [
  { id: "stt", name: "Hình", label: "Stt.", alignRight: false },
  { id: "name", label: "Tên chiến dịch", alignRight: false },
  { id: "createdAt", label: "Thời gian tham gia", alignRight: false },
  { id: "status", label: "Trạng thái", alignRight: false },
  { id: "Xóa", label: "Xem", alignRight: false },
];
                      ...
                      >
                        ...
                        <TableCell>
                          <Typography variant="subtitle2" noWrap>
                            Chiến dịch bình chọn giảng viên 2023
                          </Typography>
                        </TableCell>

                        <TableCell align="left">9:00:00 11/8/2023</TableCell>
                        <TableCell align="left">
                          <Label color="success">Đang diễn ra </Label>
                        </TableCell>
                        ...
                        <TableCell width="2%">
                          {
                            <IconButton
                              onClick={() => {
                                navigate(`/user/profilecandidate/${formId}`);
                              }}
                            >
